...
df_processed = read_csv_files("../../dataset/Processed_Dataset/client4.csv")

#df_processed = read_csv_files("../../new_dataset/new_client4.csv")
df_processed
...
df_client_train = df_client_train_ori[df_client_train_ori['target'] != 3].reset_index(drop=True)
df_client_train
...
class FlowerClient(fl.client.NumPyClient):
    ...
    def evaluate(self, parameters, config):
        ...
        torch.save(self.net.state_dict(), 'model4_new.pt')
